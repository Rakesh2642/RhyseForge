import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, nextTick, unref, resolveComponent, defineAsyncComponent, watch, readonly, mergeProps, useSSRContext, useAttrs, createVNode, resolveDynamicComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, watchEffect, createSlots, renderList, Suspense, Fragment, createTextVNode, onErrorCaptured, createApp } from "vue";
import { $fetch as $fetch$1 } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, getRequestHeader, setCookie, getCookie, deleteCookie, getHeader } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/h3/dist/index.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL, parseQuery, withTrailingSlash, withoutTrailingSlash } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/ufo/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu, defuFn, createDefu } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/defu/dist/defu.mjs";
import { klona } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/klona/dist/index.mjs";
import getURL from "requrl";
import { parse } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs";
import destr from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/destr/dist/index.mjs";
import { isEqual } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/nuxt/node_modules/ohash/dist/index.mjs";
import { createSharedComposable, useTimestamp } from "@vueuse/core";
import { extendTailwindMerge, twJoin } from "tailwind-merge";
import { useHead as useHead$1, headSymbol } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/@unhead/vue/dist/index.mjs";
import { _api, addAPIProvider, setCustomIconsLoader, getIcon, loadIcon as loadIcon$1, Icon as Icon$1 } from "@iconify/vue";
...
import { debounce } from "R:/Company Portal/products/3.Certificatation_preparation/node_modules/nuxt/node_modules/perfect-debounce/dist/index.mjs";
import { isEqual as isEqual$1, diff } from "ohash/utils";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-C0PSqSiB.js")
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/login-DR-SxNNL.js")
  },
  {
    name: "pricing",
    path: "/pricing",
    component: () => import("./_nuxt/pricing-B0NDyEix.js")
  },
  {
    name: "profile",
    path: "/profile",
    component: () => import("./_nuxt/profile-C7TIvZeY.js")
  },
  {
    name: "register",
    path: "/register",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/register-BOTj76Ir.js")
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import("./_nuxt/settings-Do5zMxqe.js")
  },
  {
    name: "exam-id",
    path: "/exam/:id()",
    component: () => import("./_nuxt/_id_-DudU2orf.js")
  },
  {
    name: "admin-login",
    path: "/admin/login",
    component: () => import("./_nuxt/login-8DQAWpdF.js")
  },
  {
    name: "admin-users",
    path: "/admin/users",
    component: () => import("./_nuxt/users-B1TaJtdj.js")
  },
  {
    name: "leaderboard",
    path: "/leaderboard",
    component: () => import("./_nuxt/leaderboard-DH3uX19s.js")
  },
  {
    name: "admin-upload",
    path: "/admin/upload",
    component: () => import("./_nuxt/upload-DYHE0Nd-.js")
  },
  {
    name: "admin-profile",
    path: "/admin/profile",
    component: () => import("./_nuxt/profile-CQVpZgcP.js")
  },
  {
    name: "admin-dashboard",
    path: "/admin/dashboard",
    component: () => import("./_nuxt/dashboard-BMqnFSzr.js")
  },
  {
    name: "dashboard",
    path: "/dashboard",
    component: () => import("./_nuxt/index-vLNc2fqQ.js")
  },
  {
    name: "admin-exams",
    path: "/admin/exams",
    component: () => import("./_nuxt/index--fOjdTJu.js")
  },
  {
    name: "admin-exams-create",
    path: "/admin/exams/create",
    component: () => import("./_nuxt/create-HhiZvjLW.js")
  },
  {
    name: "admin-review-jobId",
    path: "/admin/review/:jobId()",
    component: () => import("./_nuxt/_jobId_-da-DlO7_.js")
  },
  {
    name: "admin-exams-id-questions",
    path: "/admin/exams/:id()/questions",
    component: () => import("./_nuxt/questions-CGETg3C6.js")
  }
];
...
const namedMiddleware = {
  auth: () => Promise.resolve().then(() => auth)
};
...
const LazyUAccordion = defineAsyncComponent(() => import("./_nuxt/Accordion-5PAt2eGS.js").then((r) => r["default"] || r.default || r));
const LazyUAlert = defineAsyncComponent(() => import("./_nuxt/Alert-Q2ngCcU8.js").then((r) => r["default"] || r.default || r));
const LazyUAvatar = defineAsyncComponent(() => Promise.resolve().then(() => Avatar).then((r) => r["default"] || r.default || r));
const LazyUAvatarGroup = defineAsyncComponent(() => import("./_nuxt/AvatarGroup-DWtJAg5R.js").then((r) => r["default"] || r.default || r));
const LazyUBadge = defineAsyncComponent(() => import("./_nuxt/Badge-CzftAi4r.js").then((r) => r["default"] || r.default || r));
const LazyUButton = defineAsyncComponent(() => Promise.resolve().then(() => Button).then((r) => r["default"] || r.default || r));
const LazyUButtonGroup = defineAsyncComponent(() => import("./_nuxt/ButtonGroup-CKRsMQdW.js").then((r) => r["default"] || r.default || r));
const LazyUCarousel = defineAsyncComponent(() => import("./_nuxt/Carousel-CeSxnU4g.js").then((r) => r["default"] || r.default || r));
const LazyUChip = defineAsyncComponent(() => import("./_nuxt/Chip-oaACLlxW.js").then((r) => r["default"] || r.default || r));
const LazyUDropdown = defineAsyncComponent(() => import("./_nuxt/Dropdown-kfQ1nsxu.js").then((r) => r["default"] || r.default || r));
const LazyUIcon = defineAsyncComponent(() => Promise.resolve().then(() => Icon).then((r) => r["default"] || r.default || r));
const LazyUKbd = defineAsyncComponent(() => import("./_nuxt/Kbd-_vf6Of4T.js").then((r) => r["default"] || r.default || r));
const LazyULink = defineAsyncComponent(() => Promise.resolve().then(() => Link).then((r) => r["default"] || r.default || r));
const LazyUMeter = defineAsyncComponent(() => import("./_nuxt/Meter-BRrOQsLX.js").then((r) => r["default"] || r.default || r));
const LazyUMeterGroup = defineAsyncComponent(() => import("./_nuxt/MeterGroup-BiXikvQ1.js").then((r) => r["default"] || r.default || r));
const LazyUProgress = defineAsyncComponent(() => import("./_nuxt/Progress-Bp2H55JY.js").then((r) => r["default"] || r.default || r));
const LazyUCheckbox = defineAsyncComponent(() => import("./_nuxt/Checkbox-Cf2Up8nx.js").then((r) => r["default"] || r.default || r));
const LazyUForm = defineAsyncComponent(() => import("./_nuxt/Form-C7ZW1TTK.js").then((r) => r["default"] || r.default || r));
const LazyUFormGroup = defineAsyncComponent(() => import("./_nuxt/FormGroup-DAIqfz9h.js").then((r) => r["default"] || r.default || r));
const LazyUInput = defineAsyncComponent(() => import("./_nuxt/Input-CZAMts_N.js").then((r) => r["default"] || r.default || r));
const LazyUInputMenu = defineAsyncComponent(() => import("./_nuxt/InputMenu-DLpbKL_s.js").then((r) => r["default"] || r.default || r));
const LazyURadio = defineAsyncComponent(() => import("./_nuxt/Radio-C9H56Pal.js").then((n) => n.R).then((r) => r["default"] || r.default || r));
const LazyURadioGroup = defineAsyncComponent(() => import("./_nuxt/RadioGroup-BnhuzRZZ.js").then((r) => r["default"] || r.default || r));
const LazyURange = defineAsyncComponent(() => import("./_nuxt/Range-CR2l8VWd.js").then((r) => r["default"] || r.default || r));
const LazyUSelect = defineAsyncComponent(() => import("./_nuxt/Select-BiIxaLPN.js").then((r) => r["default"] || r.default || r));
const LazyUSelectMenu = defineAsyncComponent(() => import("./_nuxt/SelectMenu-e8RKh5Ei.js").then((r) => r["default"] || r.default || r));
const LazyUTextarea = defineAsyncComponent(() => import("./_nuxt/Textarea-Dp5yVEuD.js").then((r) => r["default"] || r.default || r));
const LazyUToggle = defineAsyncComponent(() => import("./_nuxt/Toggle-CA1O4bV-.js").then((r) => r["default"] || r.default || r));
const LazyUTable = defineAsyncComponent(() => import("./_nuxt/Table-BEEiCEEU.js").then((r) => r["default"] || r.default || r));
const LazyUCard = defineAsyncComponent(() => import("./_nuxt/Card-CgPQDjgh.js").then((r) => r["default"] || r.default || r));
const LazyUContainer = defineAsyncComponent(() => import("./_nuxt/Container-BN6VrUpB.js").then((r) => r["default"] || r.default || r));
const LazyUDivider = defineAsyncComponent(() => import("./_nuxt/Divider-B73cfw3m.js").then((r) => r["default"] || r.default || r));
const LazyUSkeleton = defineAsyncComponent(() => import("./_nuxt/Skeleton-B30dHzHb.js").then((r) => r["default"] || r.default || r));
const LazyUBreadcrumb = defineAsyncComponent(() => import("./_nuxt/Breadcrumb-BlBtWDie.js").then((r) => r["default"] || r.default || r));
const LazyUCommandPalette = defineAsyncComponent(() => import("./_nuxt/CommandPalette-B2AZ4e3T.js").then((r) => r["default"] || r.default || r));
const LazyUCommandPaletteGroup = defineAsyncComponent(() => import("./_nuxt/CommandPaletteGroup-C2rmry01.js").then((r) => r["default"] || r.default || r));
const LazyUHorizontalNavigation = defineAsyncComponent(() => import("./_nuxt/HorizontalNavigation-B23JNl3n.js").then((r) => r["default"] || r.default || r));
const LazyUPagination = defineAsyncComponent(() => import("./_nuxt/Pagination-j4y2Ere0.js").then((r) => r["default"] || r.default || r));
const LazyUTabs = defineAsyncComponent(() => import("./_nuxt/Tabs-BaoAan4u.js").then((r) => r["default"] || r.default || r));
const LazyUVerticalNavigation = defineAsyncComponent(() => import("./_nuxt/VerticalNavigation-BT2yso6F.js").then((r) => r["default"] || r.default || r));
const LazyUContextMenu = defineAsyncComponent(() => import("./_nuxt/ContextMenu-CGWHvjFk.js").then((r) => r["default"] || r.default || r));
const LazyUModal = defineAsyncComponent(() => import("./_nuxt/Modal-CHUfZEA4.js").then((r) => r["default"] || r.default || r));
...
const LazyUPopover = defineAsyncComponent(() => import("./_nuxt/Popover-Dnhq91xF.js").then((r) => r["default"] || r.default || r));
const LazyUSlideover = defineAsyncComponent(() => import("./_nuxt/Slideover-CtNh0Upn.js").then((r) => r["default"] || r.default || r));
const LazyUSlideovers = defineAsyncComponent(() => Promise.resolve().then(() => serverPlaceholder).then((r) => r["default"] || r.default || r));
const LazyUTooltip = defineAsyncComponent(() => import("./_nuxt/Tooltip-D_UtT9I8.js").then((r) => r["default"] || r.default || r));
...
const useAuthState = () => {
  const config2 = useTypedBackendConfig(/* @__PURE__ */ useRuntimeConfig());
  const commonAuthState = makeCommonAuthState();
  const _rawTokenCookie = useCookie(config2.token.cookieName, { default: () => null, maxAge: config2.token.maxAgeInSeconds, sameSite: config2.token.sameSiteAttribute });
  ...
  const token = computed(() => {
    ...
    return config2.token.type.length > 0 ? `${config2.token.type} ${rawToken.value}` : rawToken.value;
  });
...
const getRequestURL = (includePath = true) => getURL(useRequestEvent()?.node.req, includePath);
...
const signIn = async (credentials, signInOptions, signInParams) => {
  ...
  const config2 = useTypedBackendConfig(/* @__PURE__ */ useRuntimeConfig());
  const { path, method } = config2.endpoints.signIn;
  ...
  const extractedToken = jsonPointerGet(response, config2.token.signInResponseTokenPointer);
  if (typeof extractedToken !== "string") {
    console.error(`Auth: string token expected, received instead: ${JSON.stringify(extractedToken)}. Tried to find token at ${config2.token.signInResponseTokenPointer} in ${JSON.stringify(response)}`);
    return;
  }
...
const signOut = async (signOutOptions) => {
  ...
  const config2 = useTypedBackendConfig(runtimeConfig);
  const { data, rawToken, token } = await callWithNuxt(nuxt, useAuthState);
  const headers = new Headers({ [config2.token.headerName]: token.value });
  data.value = null;
  rawToken.value = null;
  const signOutConfig = config2.endpoints.signOut;
  let res;
  if (signOutConfig) {
...
const getSession = async (getSessionOptions) => {
  const nuxt = useNuxtApp();
  const config2 = useTypedBackendConfig(/* @__PURE__ */ useRuntimeConfig());
  const { path, method } = config2.endpoints.getSession;
  const { data, loading, lastRefreshedAt, token, rawToken } = useAuthState();
  if (!token.value && !getSessionOptions?.force) {
    return;
  }
  const headers = new Headers(token.value ? { [config2.token.headerName]: token.value } : void 0);
  loading.value = true;
  try {
...
const plugin_8geMXmCD2t7LWdz1cPAusc6bDgjVZXVqHcSQAUaPye8 = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  let __temp, __restore;
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BsewRDMW.js").then((m) => m.default || m))
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased font-sans text-gray-900 bg-white dark:bg-gray-950 dark:text-gray-100" }, _attrs))}>`);
  _push(ssrRenderComponent(_component_NuxtLoadingIndicator, {
    color: "repeating-linear-gradient(to right,#3b82f6 0%,#2dd4bf 50%,#3b82f6 100%)",
    height: 3
  }, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_1$1;
      const _component_UIcon = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#00040a] flex flex-col items-center justify-center text-center p-6 relative overflow-hidden selection:bg-cyan-500/30" }, _attrs))} data-v-4343c65e><div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[100vw] h-[100vh] pointer-events-none z-0" data-v-4343c65e><div class="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(45,212,191,0.15)_0%,transparent_60%)]" data-v-4343c65e></div><div class="rays absolute inset-0 opacity-40" data-v-4343c65e></div></div><div class="relative z-10 flex flex-col items-center justify-center" data-v-4343c65e><div class="relative group cursor-default" data-v-4343c65e><div class="absolute inset-0 blur-[80px] bg-cyan-400/20 rounded-full scale-150 animate-pulse" data-v-4343c65e></div><h1 class="glass-404 text-[16rem] md:text-[26rem] font-bold leading-none tracking-[0.2em] relative z-10 select-none ml-[0.2em]" data-v-4343c65e> 404 </h1><div class="absolute inset-0 z-20 mix-blend-screen pointer-events-none opacity-60" data-v-4343c65e><div class="ray-effect" data-v-4343c65e></div></div></div><div class="mt-[-20px] md:mt-[-40px] space-y-8 animate-fade-in" data-v-4343c65e><div class="space-y-4 px-4" data-v-4343c65e><h2 class="text-2xl md:text-4xl font-black text-white/90 tracking-[0.3em] uppercase" data-v-4343c65e>Service Disruption</h2><p class="text-cyan-400/60 text-[10px] md:text-sm font-black tracking-[0.5em] uppercase" data-v-4343c65e>Check connection or synchronize console</p></div><div class="flex flex-col sm:flex-row gap-6 justify-center pt-4" data-v-4343c65e>`);
      ...
      _push(`</div></div></div><div class="absolute bottom-12 left-1/2 -translate-x-1/2 z-20" data-v-4343c65e>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "flex items-center gap-3 group text-gray-500 hover:text-white transition-colors duration-500"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-[10px] uppercase tracking-[0.4em] font-black opacity-40" data-v-4343c65e${_scopeId}>Architected by</span><div class="flex items-center gap-2 px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] backdrop-blur-md group-hover:border-primary-500/30 transition-all" data-v-4343c65e${_scopeId}>`);
            _push2(ssrRenderComponent(_component_UIcon, {
              name: "i-heroicons-bolt-20-solid",
              class: "text-primary-500 group-hover:scale-125 transition-transform"
            }, null, _parent2, _scopeId));
            _push2(`<span class="text-sm font-bold tracking-widest" data-v-4343c65e${_scopeId}>RHYSE FORGE</span></div>`);
          } else {
            return [
              createVNode("span", { class: "text-[10px] uppercase tracking-[0.4em] font-black opacity-40" }, "Architected by"),
              createVNode("div", { class: "flex items-center gap-2 px-4 py-2 rounded-full border border-white/5 bg-white/[0.02] backdrop-blur-md group-hover:border-primary-500/30 transition-all" }, [
                createVNode(_component_UIcon, {
                  name: "i-heroicons-bolt-20-solid",
                  class: "text-primary-500 group-hover:scale-125 transition-transform"
                }),
                createVNode("span", { class: "text-sm font-bold tracking-widest" }, "RHYSE FORGE")
              ])
            ];
          }
        }),
      ...
      _push(`</div><div class="fixed inset-0 z-0 bg-[url(&#39;https://grainy-gradients.vercel.app/noise.svg&#39;)] opacity-[0.02] pointer-events-none" data-v-4343c65e></div></div>`);
    };
  }
};
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-4343c65e"]]);
const _sfc_main = {
  __name: "nuxt-root",
  __ssrInlineRender: true,
  setup(__props) {
...
export {
  textarea as A,
  getSlotsChildren as B,
  avatar as C,
  useProvideButtonGroup as D,
  getNuxtLinkProps as E,
  dropdown as F,
  inputMenu as G,
  selectMenu as H,
  getULinkProps as I,
