...
declare module '@nuxt/schema' {
  interface ModuleDependencies {
    ...
    ["sidebase-auth"]?: ModuleDependencyMeta<typeof import("@sidebase/nuxt-auth").default extends NuxtModule<infer O> ? O | false : Record<string, unknown>> | false
  ...
  interface NuxtOptions {
     ...
     */
    ["auth"]: typeof import("@sidebase/nuxt-auth").default extends NuxtModule<infer O, unknown, boolean> ? O | false : Record<string, any> | false
    /**
  ...
  interface NuxtConfig {
     ...
     * Configuration for `@sidebase/nuxt-auth`
     */
    ["auth"]?: typeof import("@sidebase/nuxt-auth").default extends NuxtModule<infer O, unknown, boolean> ? Partial<O> | false : Record<string, any> | false
    /**
     * Configuration for `@nuxt/devtools`
     */
    ...
    modules?: (undefined | null | false | NuxtModule<any> | string | [NuxtModule | string, Record<string, any>] | ["@nuxt/icon", Exclude<NuxtConfig["icon"], boolean>] | ["@nuxtjs/color-mode", Exclude<NuxtConfig["colorMode"], boolean>] | ["@nuxtjs/tailwindcss", Exclude<NuxtConfig["tailwindcss"], boolean>] | ["@nuxt/ui", Exclude<NuxtConfig["ui"], boolean>] | ["@pinia/nuxt", Exclude<NuxtConfig["pinia"], boolean>] | ["@sidebase/nuxt-auth", Exclude<NuxtConfig["auth"], boolean>] | ["@nuxt/devtools", Exclude<NuxtConfig["devtools"], boolean>] | ["@nuxt/telemetry", Exclude<NuxtConfig["telemetry"], boolean>])[],
  }
