declare global {
  ...
  const decodeToken: typeof import('../../server/utils/auth').decodeToken
  ...
  const getServerSession: typeof import('../../server/utils/auth').getServerSession
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'R:/Company Portal/products/3.Certificatation_preparation/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'R:/Company Portal/products/3.Certificatation_preparation/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hashPassword, verifyPassword, generateToken, decodeToken, getServerSession } from 'R:/Company Portal/products/3.Certificatation_preparation/server/utils/auth';
export { default as prisma } from 'R:/Company Portal/products/3.Certificatation_preparation/server/utils/prisma';